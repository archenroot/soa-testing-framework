...
public class MappingComponent extends SOATFComponent {
    ...
    public static Set<CompOperType> supportedOperations = CompOperType.mappingOperations;   
    ...
    public MappingComponent(MappingConfiguration mappingConfiguration, CompOperResult componentOperationResult, String identificator) {
