...
import static com.ibm.soatf.CompOperType.JMS_READ_ALL_MESSAGES_IN_QUEUE;
import static com.ibm.soatf.CompOperType.JMS_PURGE_QUEUE;
import static com.ibm.soatf.CompOperType.OSB_DISABLE_SERVICE;
import static com.ibm.soatf.CompOperType.OSB_ENABLE_SERVICE;
import static com.ibm.soatf.CompOperType.MAPPING_VALIDATE_SCENARIO;
import static com.ibm.soatf.CompOperType.JMS_VALIDATE_MESSAGE_FILES;
import static com.ibm.soatf.CompOperType.JMS_CHECK_ERROR_QUEUE_FOR_MESSAGES;
import static com.ibm.soatf.SOATFCompType.JMS;
import static com.ibm.soatf.SOATFCompType.DATABASE;
import static com.ibm.soatf.SOATFCompType.OSB;
import static com.ibm.soatf.SOATFCompType.MAPPING;
import com.ibm.soatf.database.DatabaseComponent;
import com.ibm.soatf.jms.JMSComponent;
import com.ibm.soatf.mapping.MappingComponent;
import com.ibm.soatf.osb.OSBComponent;
import com.ibm.soatf.xml.XMLComponent;
...
public class TestJMSComponent {
    ...
    public static void testJmsComponent() throws SAXException, ParserConfigurationException, IOException, FileNotFoundException, ParseException {
        ...
        //STEP 1
        OSBComponent mainQueuePoller = (OSBComponent) SOATFCompFactory.buildSOATFComponent(OSB, "VendorContactsMaintainFromEBS_047C_prequeue_listener", cor);
        mainQueuePoller.execute(OSB_DISABLE_SERVICE);
        
        //STEP 2
        OSBComponent preQueuePoller = (OSBComponent) SOATFCompFactory.buildSOATFComponent(OSB, "VendorsSitesAndContactsPS_masterqueue_listener", cor);
        preQueuePoller.executeOperation(OSB_DISABLE_SERVICE);

        //STEP 3
        JMSComponent preQueue = (JMSComponent) SOATFCompFactory.buildSOATFComponent(JMS, "IWCommonJMSServer_VendorContacts_prequeue_O47C", cor);
