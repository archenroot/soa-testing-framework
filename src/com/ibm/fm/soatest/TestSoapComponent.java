...
import static com.ibm.fm.soatest.SoaTestingFrameworkComponentType.*;
import static com.ibm.fm.soatest.SoaTestingFrameworkComponentType.ComponentOperation.*;
...
public class TestSoapComponent {
    ...
    public static void testDatabaseComponent(){
        SoapComponent soapComponent = 
                (SoapComponent) SoaTestingFrameworkComponentFactory.buildSoaTestingFrameworkComponent(SOAP);
