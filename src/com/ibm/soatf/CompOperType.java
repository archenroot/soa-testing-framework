...
public enum CompOperType {
    ...
    FTP_SEND_FILE("Send file to FTP server."),
     ...
     */
    public static final Set<CompOperType> FILE_OPERATIONS = EnumSet.of(FILE_OPERATIONS_DEFINITION_BEGIN, FILE_OPERATIONS_DEFINITION_END);

    /**
     * Constant with all supported FTP related operations.
     */
    public static final Set<CompOperType> FTP_OPERATIONS = EnumSet.of(FTP_OPERATIONS_DEFINITION_BEGIN, FTP_OPERATIONS_DEFINITION_END);

    /**
     * Constant with all supported JMS related operations.
     */
    public static final Set<CompOperType> JMS_OPERATIONS = EnumSet.of(JMS_OPERATIONS_DEFINITION_BEGIN, JMS_OPERATIONS_DEFINITION_END);

    /**
     * Constant with all supported OSB related operations.
     */
    public static final Set<CompOperType> OSB_OPERATIONS = EnumSet.of(OSB_OPERATIONS_DEFINITION_BEGIN, SOAP_OPERATIONS_DEFINITION_END);

    /**
     * Constant with all supported REST related operations.
     */
    public static final Set<CompOperType> REST_OPERATIONS = EnumSet.of(REST_OPERATIONS_DEFINITION_BEGIN, REST_OPERATIONS_DEFINITION_END);

    /**
     * Constant with all supported SOAP related operations.
     */
    public static final Set<CompOperType> SOAP_OPERATIONS = EnumSet.of(SOAP_OPERATIONS_DEFINITION_BEGIN, SOAP_OPERATIONS_DEFINITION_END);

    /**
     * Constant with all supported XML related operations.
     */
    public static final Set<CompOperType> XML_OPERATIONS = EnumSet.of(XML_OPERATIONS_DEFINITION_BEGIN, XML_OPERATIONS_DEFINITION_END);

    /**
     * Constant with all supported mapping related operations.
     */
    public static final Set<CompOperType> MAPPING_OPERATIONS = EnumSet.of(MAPPING_OPERATIONS_DEFINITION_BEGIN, MAPPING_OPERATIONS_DEFINITION_END);
