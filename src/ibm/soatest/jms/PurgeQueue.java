...
public class PurgeQueue {
 ...
 public static Context createInitialContext(OSBConfiguration osbConfig) throws NamingException {
  Hashtable<String, String> ht = new Hashtable<String, String>();
  ht.put(Context.INITIAL_CONTEXT_FACTORY, "weblogic.jndi.WLInitialContextFactory");
  ht.put(Context.PROVIDER_URL, 
          "t3://" + 
          osbConfig.getCluster().getManagedServer().get(0).getHostName() +
          ":" +
          osbConfig.getCluster().getManagedServer().get(0).getPort()
  );
 ...
 public void init(JMSConfiguration jmsConfig, OSBConfiguration osbConfig) throws Exception {
 ...
 public void deleteAllMessagesFromQueue(JMSConfiguration jmsConfig, OSBConfiguration osbConfig) throws Exception {
