...
import java.io.*;
import java.sql.*;
import ibm.soatest.tool.RandomGenerator;
...
public final class StatementGenerator {
    ...
    public static void generateInsertStatement(Connection conn, DbObject object, String outputFilePath, CompOperResult cor) throws StatementGeneratorException {
        File file = null;
        String objectName = object.getName();
        List<DbObject.CustomValue> customValues = object.getCustomValue();
        
        Map<String, String> customValuesMap = new HashMap<String, String>();
