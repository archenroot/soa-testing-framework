 ...
 * @author zANGETSu
 */
public abstract class SOATFConfig {
    ...
    public SOATFConfig (String soaTestingFrameworkXmlConfigFile){
    ...
    public SoaTestingFramework getSoaTestingFramework() throws IOException{
        try {
            ...
            Logger.getLogger(SOATFConfig.class.getName()).log(Level.SEVERE, null, ex);
        }
        return null;
    }
   */
