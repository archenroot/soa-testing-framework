...
/**
 * Util component exception class is thrown within database component
 * operation execution. Every checked and some unchecked exceptions are wrapped
 * by this class.
 *
 * @author Ladislav Jech <archenroot@gmail.com>
 */
public class UtilComponentException  extends FrameworkExecutionException {

    /**
     * General constructor.
     */
    public UtilComponentException() {
        super();
    }
     ...
     */
    public UtilComponentException(final String message) {
        super(message);
    }
     ...
     */
    public UtilComponentException(final Throwable cause) {
        super(cause);
    }
