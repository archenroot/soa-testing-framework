...
class SampleXmlUtil {
    ...
    private String sampleDataForSimpleType(SchemaType sType) {
        ...
        while ((baseType.getPatterns() == null || baseType.getPatterns().length == 0) && baseType.getBaseType() != null) {
...
//                return Double.valueOf(new Random().nextDouble()).toString();
    ...
    public static final Set<QName> SKIPPED_SOAP_ATTRS = new HashSet<>(Arrays.asList(new QName[]{HREF, ID, ENC_OFFSET}));
