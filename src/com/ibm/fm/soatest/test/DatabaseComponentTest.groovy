...
identificator. Analyze defined object and 
<dbconf:database identificator=""> atribute value. It analyses the defined object
physical structure and generate INSERT statement for single row into file defined
in element
