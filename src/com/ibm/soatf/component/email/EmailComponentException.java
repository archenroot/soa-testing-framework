 ...
 */
public class EmailComponentException extends FrameworkExecutionException {

    /**
     * General constructor.
     */
    public EmailComponentException() {
        super();
    }
     ...
     */
    public EmailComponentException(final String message) {
        super(message);
    }
     ...
     */
    public EmailComponentException(final Throwable cause) {
        super(cause);
    }
