...
public final class Wsdl {
    ...
    public static Wsdl parse(URL wsdlUrl) {
        if (wsdlUrl == null) {
            throw new SoapBuilderException("URL of the WSDL cannot be null");
        }
    ...
    public SoapBuilderFinderImpl binding() {
    ...
    class SoapBuilderFinderImpl {
        ...
        public SoapBuilderFinderImpl name(String name) {
            return name(QName.valueOf(name));
        }

        public SoapBuilderFinderImpl name(QName name) {
        ...
        public SoapBuilderFinderImpl namespaceURI(String namespaceURI) {
            this.namespaceURI = namespaceURI;
            return this;
        }

        public SoapBuilderFinderImpl localPart(String localPart) {
            this.localPart = localPart;
            return this;
        }

        public SoapBuilderFinderImpl prefix(String prefix) {
            this.prefix = prefix;
            return this;
        }
    ...
    public SoapBuilder getBuilder(String bindingName, SoapContext context) {
        if (bindingName == null) {
            throw new SoapBuilderException("BindingName cannot be null");
        }        
    ...
    public SoapBuilder getBuilder(QName bindingName, SoapContext context) {
        ...
        if (context == null) {
            throw new SoapBuilderException("SoapContext cannot be null");
        }         
        Binding binding = soapFacade.getBindingByName(bindingName);
        return new SoapBuilder(soapFacade, binding, context);
    }
